<%@ Page Title="" Language="C#" MasterPageFile="~/ConsoleView/Site1.Master" AutoEventWireup="true" CodeBehind="CooperationList.aspx.cs" Inherits="OfficialWebsite.ConsoleView.CooperationList" %>
    ...
    <div class="page-content">
        ...
        <div class="row">
            <div class="col-xs-12">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
                                                <a class="green" href="Addcooperation.aspx?cid=<%#Eval("ID") %>">
                ...
                <div class="col-xs-12 center"><label id="addteam" class="btn btn-success">新增</label></div>
            </div>
        </div>
    </div>
</asp:Content>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            $("#addteam").click(function () {
                location.href = "Addcooperation.aspx";
            });
            $(".red").click(function () {
                $.ajax({
                    type: "post",
                    url: "ashx/ow_cooperationHandler.ashx?deleteid=" + $(".red").attr("name"),
