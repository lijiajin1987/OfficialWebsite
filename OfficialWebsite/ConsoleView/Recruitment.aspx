<%@ Page Title="" Language="C#" MasterPageFile="~/ConsoleView/Site1.Master" AutoEventWireup="true" CodeBehind="Recruitment.aspx.cs" Inherits="OfficialWebsite.ConsoleView.Recruitment" %>
                            ...
                            <asp:Repeater ID="repdata" runat="server">
                                <ItemTemplate>
                                    <tr>
                                        ...
                                        <td><%#Eval("WorkingAddress") %></td>
                                        <td><%#Eval("JobResponsibilities") %></td>
                                        <td><%#Eval("JobRequirements") %></td>
                                        <td><%#Eval("MailBox") %></td>
                                        <td class="hidden-480"><%#Eval("CreateDate") %></td>
                                        <td><%#Eval("UpdateDate") %></td>
                                        <td>
                                            <div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
                                                <a class="green" href="AddRecruitment.aspx?jobid=<%#Eval("ID") %>">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            $("#addteam").click(function () {
                location.href = "AddRecruitment.aspx";
            });
            $(".red").click(function () {
                $.ajax({
                    type: "post",
                    url: "ashx/ow_jobHandler.ashx?jobid="+ $(".red").attr("name"),
