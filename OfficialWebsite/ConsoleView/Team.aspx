<%@ Page Title="" Language="C#" MasterPageFile="~/ConsoleView/Site1.Master" AutoEventWireup="true" CodeBehind="Team.aspx.cs" Inherits="OfficialWebsite.ConsoleView.Team" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="page-content">
        ...
        <div class="page-header">
            团队标题:<asp:TextBox runat="server" ID="txtTeamTitle"></asp:TextBox>
            <asp:Button class="btn btn-info" type="button" id="btnSubmit" runat="server" Text="保存" OnClick="btnSubmit_Click" />
        </div>
        <div class="row">
            <div class="col-xs-12">
                            ...
                            <asp:Repeater ID="repdata" runat="server">
                                <ItemTemplate>
                                    <tr>
                                        ...
                                        <td class="hidden-480"><%#Eval("createdatetime") %></td>
                                        <td><%#Eval("updatetime") %></td>
                                        <td>
                                            <div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
                                                <a class="green" href="UPTeam.aspx?id=<%#Eval("id") %>">
                ...
                <div class="col-xs-12 center">
                    <label id="addteam" class="btn btn-success">新增</label></div>
            </div>
        </div>
    </div>
</asp:Content>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            $("#addteam").click(function () {
                location.href = "UPTeam.aspx";
            });
            $(".red").click(function () {
                $.ajax({
                    type: "post",
                    url: "ashx/delTeamHandler.ashx",
                    data: { teamid: $(".red").attr("name") },
                    dataType: "json",
