...
{
    /// <summary>
    /// UploadPicturesHandler 的摘要说明
    /// </summary>
    public class UploadPicturesHandler : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            foreach (string fileName in httpFileCollection)
            {
                ...
                if (file != null && file.ContentLength > 0)
                {
                    ...
                    string pathString = System.IO.Path.Combine(originalDirectory.ToString(), "Team");
